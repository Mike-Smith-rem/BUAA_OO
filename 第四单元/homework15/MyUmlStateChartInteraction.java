...
public class MyUmlStateChartInteraction implements UmlStateChartInteraction {
    ...
    private Map<String, Integer> outTime = new HashMap<>();
    private ArrayList<String> transitNotValid = new ArrayList<>();
    ...
    public MyUmlStateChartInteraction(UmlElement... elements) {
        ...
        for (UmlElement e : level4) {
            ...
            String guard = e1.getGuard();
            if (outTime.containsKey(source)) {
                transitNotValid.add(id);
                outTime.put(source, outTime.get(source) + 1);
                if (guard != null) {
                    r008 = true;
                }
            }
        ...
        for (UmlElement e : level5) {
            ...
            if (e instanceof UmlEvent) {
                ...
                if (transitNotValid.contains(parent)) {
                    r008 = true;
                }
    ...
    public void check08() throws UmlRule008Exception {
        for (String s : outTime.keySet()) {
            if (outTime.get(s) != 1) {
