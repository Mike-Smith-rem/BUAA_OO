...
public class MyUmlCollaborationInteraction implements UmlCollaborationInteraction {
    private Map<String, String> id2Inter = new HashMap<>();
    ...
    public MyUmlCollaborationInteraction(UmlElement... elements) {
        ...
        Map<String, String> ref2Inter = new HashMap<>();
        ...
        for (UmlElement e : level3) {
            ...
            String parent = e.getParentId();
            String name = e.getName();
            String ref = ((UmlLifeline) e).getRepresent();
            if (ref == null) {
                r007 = true;
            } else {
                add = true;
                ref2Inter.put(ref, parent);
            }
            id2attr.put(id, name);
        ...
        for (UmlElement e : level5) {
            String id = e.getId();
            String parent = e.getParentId();
            if (ref2Inter.containsKey(id)) {
                if (!ref2Inter.get(id).equals(id2Inter.get(parent))) {
                    r007 = true;
                    break;
                }
                ref2Inter.remove(id);
    ...
    public void check07() throws UmlRule007Exception {
        if (r007) {
